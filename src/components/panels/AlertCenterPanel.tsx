...
export default function AlertCenterPanel() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Top Banner */}
      <div className="p-3 rounded-2xl border flex items-center justify-between shadow-xs bg-red-50 border-red-200">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] mt-0.5 font-medium text-red-700/90">
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-[10px] font-bold px-1.5 py-0.2 rounded border text-[#7c2d12] bg-[#fff7ed] border-[#fed7aa]">
                    {spot.eventId}
                  </span>
                </div>
              ...
              <div>
                <h3 className="text-[13px] font-extrabold leading-snug text-[#261006]">
                  {spot.name}
                </h3>
              ...
              {/* Radiative Stats Box */}
              <div className="flex items-center justify-between p-2 rounded-xl border text-[11px] bg-[#fff7ed] border-[#fed7aa]">
              ...
              <div className="flex items-center gap-2 pt-1">
                <button
                  ...
                  className="flex-1 py-1.5 px-2.5 rounded-xl text-[10.5px] font-semibold flex items-center justify-center gap-1 border shadow-xs transition-all cursor-pointer bg-[#ffedd5] hover:bg-[#fed7aa] text-[#c2410c] border-[#fed7aa]"
                >
                  <Crosshair size={13} />
                ...
                <button
                  ...
                  className="py-1.5 px-2.5 rounded-xl border text-[10.5px] font-medium transition-all cursor-pointer shadow-xs bg-white border-[#fed7aa] text-[#7c2d12] hover:text-[#261006] hover:bg-[#ffedd5]"
