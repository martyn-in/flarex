    ...
    <div className="flex flex-col gap-3.5">
      ...
      <div className="flarex-kpi-grid">
        <div className="flarex-kpi">
          ...
          <span className="flarex-kpi-value text-[#261006]">{persistentList.length}</span>
        ...
        <div className="flarex-kpi">
          ...
          <span className="flarex-kpi-value text-purple-600">22.4 d</span>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex rounded-xl p-1 border bg-[#ffedd5] border-[#fed7aa]">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  <h4 className="text-[12.5px] font-extrabold leading-snug text-[#261006]">
              ...
              <div className="grid grid-cols-3 gap-2 py-2 px-2.5 rounded-xl border text-center bg-[#fff7ed] border-[#fed7aa]">
                <div>
                ...
                <div>
                  ...
                  <span className="font-mono text-[11px] font-bold text-[#261006]">
                    {spot.baselineFrp} MW
                  </span>
                </div>
                <div>
              ...
              <div className="flex items-center justify-between text-[10px] pt-1 border-t border-[#fed7aa] text-[#7c2d12]">
                <span className="font-semibold text-[#261006]">{spot.classification}</span>
