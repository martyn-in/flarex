...
function initSchema(db: Database.Database) {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS thermal_events (
      ...
      behaviour_status TEXT DEFAULT 'NORMAL',
      thermal_abnormality_score REAL DEFAULT 0,
      robust_z_score REAL DEFAULT 0,
      surge_ratio REAL DEFAULT 1.0,
      historical_percentile REAL DEFAULT 50,
      mad_frp_30d REAL DEFAULT 2.0,
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS persistent_sources (
      ...
      active_days_90d INTEGER DEFAULT 1,
